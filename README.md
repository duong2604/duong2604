...
Mid-level fullstack developer with hands-on experience building scalable web applications and distributed systems. Focused on writing clean, maintainable code and designing systems that hold up under real-world load.

- Currently deepening expertise in **System Design** and **Microservices architecture**
- Experienced across the full delivery lifecycle — from API design to production deployment
- Ask me about **React**, **Next.js**, **Node.js**, **TypeScript**, or **event-driven architecture**
